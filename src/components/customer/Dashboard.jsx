            ...
            <div className="features row featuresDiv">
              <div className="featuresdiv col-md-6">
                ...
                <h4>
                  ...
                  Earum fugit amet rerum veniam ducimus doloribus, in tempore
            ...
            <div className="features row featuresDiv">
              <div className="featuresdiv col-md-6">
                ...
                <h4>
                  ...
                  earum porro blanditiis ad culpa distinctio sapiente sequi
                  ipsum laudantium corporis magni omnis at!
                </h4>
              </div>
              <div className="col-md-6">
                <img
